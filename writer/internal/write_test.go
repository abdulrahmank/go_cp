...
func TestWrite(t *testing.T) {
	t.Run("Should be able to write the given byte Array to disk using mapunmap", func(t *testing.T) {
	...
	t.Run("Should be able to write the given byte Array to disk using file io", func(t *testing.T) {
		file := "../../test_resource/write_sample.txt"
		content := "Writing sample content in file using munmap"
